...
<%@page import="com.online_banking.example.DB_Transfer"%>
...
<body>
	...
	if(nat_id.length() > 0 && nat_id.equals("bad")){
		...
		if(	request.getParameter("des_bank") != null && 
			request.getParameter("des_person") != null &&
			request.getParameter("des_card") != null && 
			request.getParameter("amount") != null &&
			request.getParameter("country") != null &&
			request.getParameter("email") != null &&
			request.getParameter("password") != null){
			
			String dest_bank_name = request.getParameter("des_bank");
			String dest_person_name = request.getParameter("des_person");
			String dest_card_number = request.getParameter("des_card");
			String amountStr = request.getParameter("amount");
			String dest_country = request.getParameter("country");
			String email = request.getParameter("email");
			String password = request.getParameter("password");

			if(dest_bank_name.length() > 0 && dest_person_name.length() > 0 && dest_card_number.length() > 0 && amountStr.length() > 0 && dest_country.length() > 0 && email.length() > 0 && password.length() > 0){
				...
				try {
					...
					if(login.checkValidUser(email, password)){
						if(latestBalance != (double)-1 && oldBalance > 0){
							DB_Transfer trans = new DB_Transfer(this.user.getNat_id());
							trans.updateDatabase(dest_card_number, dest_person_name, dest_bank_name, amount, oldBalance, latestBalance, dest_country);
							out.println("<script>alert('The transfer is already done successfully');</script>");
						}else{
							...
							<div class="tab">
								...
								<div class="tab-content">
									<div class="fields">
										<div class="row">
											<div>
												<label for="des_bank">Destination Bank</label>
											</div>
											<div>
												<input type="text" id="des_bank" name="des_bank">
											</div>
										</div>
										<div class="row">
											<div>
												<label for="des_person">Delivered Person</label>
											</div>
											<div>
												<input type="text" id="des_person" name="des_person">
											</div>
										</div>
										<div class="row">
											<div>
											...
											<div>
												<select id="des_country" name="country">
							...
							<div class="tab">
								...
								<div class="tab-content">
									<div class="fields">
										...
										<div class="row">
											<div>
												<label for="des_card">Card Number</label>
											</div>
											<div>
												<input type="text" id="des_card" name="des_card">
											</div>
										</div>
										<div class="btn">
											<button type="reset">Clear</button>
